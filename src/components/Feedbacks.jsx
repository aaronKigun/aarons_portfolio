...
const Feedbacks = () => {
  return (
    <div className={`mt-12 bg-sky-800 rounded-[20px]`}>
      <div
        className={`bg-[#383E56] rounded-2xl ${styles.padding} min-h-[300px]`}
      >
        <motion.div variants={textVariant()}>
          <p className={styles.sectionSubText}>What others say</p>
          <h2 className='text-orange-400 font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]'>Testimonials.</h2>
        </motion.div>
      </div>
